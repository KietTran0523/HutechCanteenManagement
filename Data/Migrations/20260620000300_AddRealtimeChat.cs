        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConversationKey = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_ConversationKey_SentAt",
                table: "ChatMessages",
                columns: new[] { "ConversationKey", "SentAt" });
